...
def separate_appetizers(dishes, appetizers):
    ...
    deduped_dishes = list(set(dishes))
    deduped_appetizers = list(set(appetizers))
    return [dish for dish in deduped_dishes if dish not in deduped_appetizers]
...
def singleton_ingredients(dishes, intersection):
    ...
    all_ingredients = set()
    duplicated_ingredients = set()

    for dish in dishes:
        duplicated_ingredients |= (dish & intersection)

    for dish in dishes:
        all_ingredients |= dish

    singleton_ingredients = all_ingredients - duplicated_ingredients
